...
{
    public class ListInventory : Packet
    {
        private byte numberOfItems;

        public ListInventory(byte numberOfItems)
        {
            this.data = new byte[6 + (numberOfItems*67)];
            this.ID = 0x0502;
            this.offset = 4;
